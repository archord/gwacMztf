...
def domatch1(hp, tidxs, origIdx, tpath, fname):
    ...
    for td in tdata00:
        ...
        try:
            ...
            gc = SkyCoord(ra=ra1*u.degree, dec=dec1*u.degree, frame='fk5')
            aa=gc.transform_to(FK5(equinox='J2018.0'))
            ra1=aa.ra.degree
            dec1=aa.dec.degree
    ...
    if len(tmatched)>0:
        destDir = '/data/work/wj/crossmatch200722'
